...
export default function Chatbot({ subjectId }) {
  ...
  const askChatbot = async () => {
    ...
    try {
      ...
      // For streaming, we'll use fetch with streaming response
      ...
      setMessages(prev => prev.map(msg => 
        msg.id === botMessageId 
          ? { 
              ...msg, 
              content: "I'm sorry, I'm having trouble connecting right now. Please make sure you're logged in and try again." 
            }
          : msg
      ));
      setIsTyping(false);
